...
| ------------ | ---------: | ----------------: | -------------: | -----------: | ----------: |
| **LightGBM** | **0.7359** |        **0.7326** |     **0.7408** |   **0.7329** |  **0.7379** |
| XGBoost      |     0.6888 |            0.6892 |         0.6961 |       0.6861 |      0.6913 |
...
| 모델           |      Train |       Test |
| ------------ | ---------: | ---------: |
| **LightGBM** | **0.8034** | **0.7329** |
| XGBoost      |     0.7303 |     0.6861 |
| LSTM         |     0.7365 |     0.6754 |
...
| --------- | ---------: | --------: | ---------: |
| **저렴(0)** | **11,953** |     1,961 |        332 |
| **적정(1)** |      4,770 | **9,257** |      2,147 |
| **비쌈(2)** |        895 |     6,151 | **14,770** |
...
| 실제 \ 예측   |      저렴(0) |      적정(1) |      비쌈(2) |
| --------- | ---------: | ---------: | ---------: |
| **저렴(0)** | **12,220** |      1,740 |        286 |
| **적정(1)** |      3,928 | **10,171** |      2,075 |
| **비쌈(2)** |        528 |      5,237 | **16,051** |

    ...
    <footer className="border-t bg-gray-50 text-[11px] text-gray-500">
      ...
      <div className="border-t border-gray-200 bg-gray-100">
        <div className="mx-auto max-w-6xl px-4 py-6 text-center">
          ...
          <div className="flex flex-col gap-2 text-[11px] text-gray-600 md:flex-row md:flex-wrap md:gap-x-6 md:justify-center">
            <div className="flex gap-1 justify-center">
              <span className="font-medium text-gray-500">TEAM</span>
              <span>ONDO HOUSE</span>
            </div>
            <div className="flex gap-1 justify-center">
              <span className="font-medium text-gray-500">문의</span>
              <Link
          ...
          <div className="mt-4 text-[11px] text-gray-500">
            © {currentYear}{" "}
            <span className="font-medium text-gray-700">ONDO HOUSE Team</span>. All
            rights reserved.
          </div>
        </div>
      </div>

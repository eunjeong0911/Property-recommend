...
if Path("/data/ML/trust").exists():
    TEMP_MODEL_PATH = "/data/ML/trust/temp_trained_models.pkl"
    FINAL_MODEL_PATH = "/data/ML/trust/final_trust_model.pkl"
    EVAL_RESULTS_PATH = "/data/ML/trust/model_eval_results.csv"

...
class CommunityCommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'content', 'author_name', 'author_email', 'author_profile_image', 'is_owner', 'created_at', 'updated_at', 'is_deleted']
        read_only_fields = ['id', 'author_name', 'author_email', 'author_profile_image', 'is_owner', 'created_at', 'updated_at']
...
class CommunityPostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_liked', 'is_owner', 'created_at', 'updated_at', 'is_deleted'
        ]
...
class CommunityPostListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'board_type', 'region', 'dong', 'complex_name',
            'view_count', 'like_count', 'comment_count', 'is_liked', 'is_owner',
